...
link1_status=$(curl -Is https://drive.minhhungtsbd.workers.dev/0:/Windows_Server_2012_R2x64.ISO | grep HTTP | cut -f2 -d" " | head -1)
link2_status=$(curl -Is https://drive.minhhungtsbd.workers.dev/0:/Windows_Server_2012_R2x64.ISO | grep HTTP | cut -f2 -d" ")
#sudo wget -P /mediabots https://drive.minhhungtsbd.workers.dev/0:/Windows_Server_2012_R2x64.ISO # Windows Server 2012 R2 
if [ $link1_status = "200" ] ; then 
	sudo wget -O /mediabots/WS2012R2.ISO https://drive.minhhungtsbd.workers.dev/0:/Windows_Server_2012_R2x64.ISO 
elif [ $link2_status = "200" -o $link2_status = "301" -o $link2_status = "302" ] ; then 
	sudo wget -P /mediabots https://drive.minhhungtsbd.workers.dev/0:/Windows_Server_2012_R2x64.ISO
else
